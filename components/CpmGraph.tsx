...
function Arrow({ edge }: { edge: EdgeLayout }) {
  ...
  return (
    <>
      ...
      />
      <Polygon
        points={`${ax},${ay} ${ax - 10},${ay - 5} ${ax - 10},${ay + 5}`}
        fill={color}
      />
    </>
  );
    ...
    <>
      <View style={[styles.wrapper, { width: graphWidth }]}>
        <ScrollView
          ...
          style={[
            styles.outerScroll,
            Platform.OS === "web" && { height: GRAPH_HEIGHT },
          ]}
      ...
      {tooltip &&
        ...
        createPortal(
          <View
            style={[
              styles.tooltip,
              { left: tooltip.mouseX - 160, top: tooltip.mouseY + 30 } as any,
            ]}
          >
